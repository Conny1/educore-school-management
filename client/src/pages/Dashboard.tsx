...
import { findandfilter } from "@/types";
...
const Dashboard: React.FC = () => {
  ...
  const { data} =
    useFindAndfilterPaymentsQuery(filters);
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <StatCard
          ...
          value={dashboardSumm?.data.studentCount || 0}
          icon={Users}
        ...
        <StatCard
          title="Staff Count"
          value={dashboardSumm?.data.staffCount || 0}
          icon={Briefcase}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 min-h-0">
        ...
        <div className="lg:col-span-2 sms-card flex flex-col">
          <div className="sms-card-header">
            ...
            className="text-[0.75rem] bg-none border-none text-primary font-bold cursor-pointer">
              View All
            </button>
          </div>
                  ...
                  return (
                    <tr key={payment._id}>
                      <td className="font-mono text-[0.8rem]">
                        #{payment.receiptNo.replace("RCP/", "RCP-")}
                      </td>
                      <td>
            ...
            <div className="flex flex-col divide-y divide-gray-100">
              {inventoryAlerts.length > 0 ? (
                inventoryAlerts.map((item) => (
                  ...
                  >
                    <span className="text-[0.875rem] font-medium text-text-main">
                      {item.name}
                    </span>
                    <span className="text-[0.8125rem] text-danger font-bold">
          ...
          {/* <div className="sms-card">
            ...
            <div className="p-5 flex flex-col gap-4">
              ...
              <div className="mt-2 text-[0.75rem] text-text-muted leading-relaxed">
                <strong>Note:</strong> 28 students marked absent today. Primary
                reason recorded: Seasonal Flu.
              </div>
            </div>
          </div> */}
        </div>
