  ...
  return (
    <div>
      <Modal
        ...
        title={
          editingExpense ? "Update Expense Record" : "New Expenditure Entry"
        }
        size="md"
      >
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <input
                type="number"
                {...register("amount")}
                className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm font-bold text-red-600"
              />
              {errors.amount && (
          ...
          <div className="pt-4 flex justify-end gap-3 border-t border-gray-100">
            ...
            <button
              ...
              type="submit"
              className="px-6 py-2 bg-red-600 text-white rounded-xl text-sm font-bold hover:bg-red-700 shadow-lg shadow-red-100"
            >
            { (creating || loading)?<Loading size="sm" />:"Save Expense"}
            </button>
          </div>
        </form>
      </Modal>
